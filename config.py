...
# سقف أخف لتعارض الماركة تحديداً (لو الطرفين عندهم ماركة مستخرجة بثقة
# معقولة وهي مختلفة) - أخف من التعارض البنيوي لأن استخراج الماركة تخمين
# ضعيف عمداً (أول كلمة غير وصفية بالنص)، ممكن يكون خطأ OCR/قراءة، فما نعاقبه
# بنفس صرامة تعارض حجم/عدد/وحدة مؤكد رقمياً - يبقى تحته عتبة القبول التلقائي
# فيمنعه عملياً، بس يبقى مرئي كاقتراح للمراجعة البشرية
MATCH_BRAND_CONFLICT_CAP = 65
